              ...
              children: [
                ...
                _buildCollapsibleSection(
                  ...
                  content: _eulaText,
                    ...
                    .slideY(begin: 0.15, end: 0, duration: const Duration(milliseconds: 600)),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    .animate()
                    .fadeIn(delay: const Duration(milliseconds: 900), duration: const Duration(milliseconds: 500)),
                const SizedBox(height: 24),
  ...
  Widget _buildAgreeButton(WidgetRef ref) {
    return Stack(
      ...
      children: [
        ...
        .animate()
        .fadeIn(delay: const Duration(milliseconds: 1000), duration: const Duration(milliseconds: 600))
        .slideY(begin: 0.3, end: 0, duration: const Duration(milliseconds: 600));
  }
  ...
  Widget _buildDeclineButton() {
    return OutlinedButton(
      ...
      child: Row(
        ...
        .animate()
        .fadeIn(delay: const Duration(milliseconds: 1100), duration: const Duration(milliseconds: 600));
  }
