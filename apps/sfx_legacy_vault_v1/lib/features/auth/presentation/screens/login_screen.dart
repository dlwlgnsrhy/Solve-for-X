                    ...
                    children: [
                      ...
                      Text(
                        ...
                        textAlign: TextAlign.center,
                          ...
                          .animate()
                          .fadeIn(delay: const Duration(milliseconds: 350), duration: const Duration(milliseconds: 500)),
                      ...
                      _buildTextField(
                        ...
                        validator: (value) {
                          ...
                          .animate()
                          .fadeIn(delay: const Duration(milliseconds: 400), duration: const Duration(milliseconds: 500))
                          .slideX(begin: -0.3, end: 0, duration: const Duration(milliseconds: 500)),
  ...
  Widget _buildShieldHero() {
    return SizedBox(
      ...
      child: Stack(
        ...
        .scale(begin: const Offset(0.8, 0.8), duration: const Duration(milliseconds: 500));
  }
