...
* **관련 커밋:**
  * `Commit 11-1`: `feat(infra/engine): implement precise compiler traceback parser for self-healing loop (resolves #11)`
  * `Commit 11-2`: `feat(infra/engine): apply AST pinpoint re-writing rules for localized lint corrections (refs #11)`
