...
* **관련 커밋:**
  * `Commit 12-1`: `feat(infra/engine): implement Flutter index.html base href regex auto-patcher (resolves #12)`
  * `Commit 12-2`: `feat(apps/brand-web): establish registry mapper and dynamic iframe loader interface (refs #12)`
